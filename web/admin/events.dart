...
final List<dynamic> inputElements = [name, urlReadMore, urlSignup, dateStart, dateEnd, street, city, country, language];
...
Future main() async
{
  ...
  table.addColumnSet({"id":"url_readmore", "type":"input-url", "maxlength":"256", "width":"30em"});
  ...
  table.addColumnSet({"id":"street", "type":"input-text", "maxlength":"128", "required":"0", "width":"10em"});
