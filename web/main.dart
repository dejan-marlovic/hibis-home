...
Future main() async
{
  ...
  Response response = await Messenger.post(new Request("get_rows", "events", {"columns":"id, name, url_readmore, url_pdf, url_signup, date_start, date_end, street, city, country, lang", "where":"date_start >= '$now'", "limit":"5", "order_by":"date_start ASC"}));
